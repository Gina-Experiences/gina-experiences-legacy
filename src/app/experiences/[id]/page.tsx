...
export default function ExperiencePage() {
    ...
    return (
        <nav className="w-full flex justify-center text-ginaBlack">
            <div className="w-full max-w-screen-2xl items-center flex justify-between p-8">
                <div className="w-full h-full flex flex-col rounded-3xl bg-ginaWhite">
                    ...
                    <div className="h-5/6 py-16 px-8 md:py-20 md:px-32">
                        <div className="h-auto xl:h-[80svh] grid lg:grid-rows-[auto_auto] grid-cols-1 lg:grid-cols-2 grid-rows-1 gap-12">
                            <div>
                                <Image
                            ...
                            <div className="flex flex-col justify-between">
                                <div className="flex flex-col xl:flex-row justify-between items-start ">
                                    <div className="flex flex-col space-y-4 w-full xl:w-[65%]">
