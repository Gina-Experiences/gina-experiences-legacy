   ...
   return (
      <div className="flex justify-center my-6">
         ...
         <div className="flex flex-col lg:w-1/2 justify-center items-center mx-12 my-6 space-y-4">
            ...
            <p className="text-sm lg:text-lg lg:mx-12">Discover the best travel deals and exclusive offers, tailored to make your dream vacation affordable and unforgettable.</p>
