...
const LoginPopup = () => {
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                <Dialog.Overlay className="fixed inset-0 z-[60] backdrop-blur-md bg-black/30" />
                <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[70]">
                        ...
                        <div className="flex flex-col w-screen lg:w-1/2 p-8 text-center items-center text-ginaBlack justify-center space-y-8">
                            ...
                            >
                                <input
                                    ...
                                    onFocus={() =>
                                        handleFocus(email, setEmail, 'Email')
                                    }
                                    onBlur={() =>
                                        handleBlur(email, setEmail, 'Email')
                                    }
