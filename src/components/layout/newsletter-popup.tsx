    ...
    return (
        <div className="flex lg:rounded-3xl w-screen max-w-screen-lg bg-ginaWhite lg:shadow-xl">
            ...
            <div className="flex flex-col w-screen lg:w-1/2 p-8 text-center items-center text-ginaBlack justify-center space-y-8">
                <h2 className="text-3xl font-bold lg:text-end bg-[linear-gradient(90deg,rgba(255,209,0,1)0%,rgba(246,147,29,1)30%,rgba(0,160,75,1)78%,rgba(27,20,100,1)100%)] text-transparent bg-clip-text">
                    Interested to <br />
                    Find Out More?
                </h2>
                <p className="text-sm font-medium lg:text-start px-8">
                ...
                <div className="space-y-5">
                    <div className="flex space-x-2 lg:space-x-4">
                        <img
                            ...
                            className="w-6"
                        />
                        <span className="w-full flex text-xs justify-center items-center lg:justify-start">
                ...
                <Form
                    action="/"
                    className="flex flex-col lg:flex-row items-center justify-center lg:space-x-4 space-y-5 lg:space-y-0"
                >
                    <input
                        type="text"
                        value={email}
