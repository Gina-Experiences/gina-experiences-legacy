                  ...
                  <div className="flex flex-col w-screen lg:w-1/2 p-8 text-center items-center text-ginaBlack justify-center space-y-8">
                     ...
                     <Form action="/" className="flex flex-col items-center justify-center w-5/6 space-y-2 lg:space-x-0">
                        ...
                        <div className="flex space-x-2">
                           ...
                           onFocus={() => handleFocus(Birthdate, setBirthdate, "Date of Birth")}
                           onBlur={() => handleBlur(Birthdate, setBirthdate, "Date of Birth")}
                     ...
                     <div className="flex gap-4">
                        <input
                           ...
                           required
                        />
                        <span className="text-xs">Agree to the terms and conditions</span>
                     </div>
                     ...
                     <p className="text-ginaBlue text-sm cursor-pointer">Already have an account? Login here!</p>
                  </div>
               </div>
            </Dialog.Content>
         </Dialog.Portal>
