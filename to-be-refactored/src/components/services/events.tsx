        ...
        <div className="max-w-screen-2xl flex flex-col lg:flex-row-reverse justify-center items-center p-8 mb-24 shadow-xl bg-ginaWhite ">
            ...
            <div className="flex flex-col lg:w-1/2 justify-center items-center text-center lg:text-start mx-12 my-6 space-y-4">
                ...
                <p className="text-sm lg:text-lg lg:mx-12">
                    Our commitment to local partnerships and sustainable
                    practices means that each event not only captivates guests
                    but also supports the community and preserves the
                    environment.
                </p>
                <button className="px-8 py-2 rounded-xl bg-ginaOrange text-white font-bold shadow-md">
                    View More!
                </button>
            </div>
        </div>
